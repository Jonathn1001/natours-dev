...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxnbmFzIiwiYSI6ImNsZGx0Y2xqaDAycXAzcG13bXF1OXZjMzMifQ.XfpE-2g1SsSs644GB6WFhg';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Please check your email to reset password!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(password, confirmation, token) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MZB5uKt6WDH0mQk7GCztriPycVvRdqfAaIlVtjBByoaWwU2u98ga67t2pNTSXI6uRkMaNGFgLPtih5ejCW2tlF0004jNahg4s');
...
var bookingTourBtn = document.getElementById('book-tour');
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          name = document.getElementById('name').value;
          email = document.getElementById('email').value;
          photo = document.getElementById('uploadPhoto').files[0];
...
if (bookingTourBtn) {
  bookingTourBtn.addEventListener('click', /*#__PURE__*/function () {
...
},{"./mapbox.js":"mapbox.js","./login.js":"login.js","./forgotPassword.js":"forgotPassword.js","./resetPassword.js":"resetPassword.js","./signup.js":"signup.js","./updateSettings.js":"updateSettings.js","./stripe.js":"stripe.js","./alerts.js":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
